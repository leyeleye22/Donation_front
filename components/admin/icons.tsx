...
export function IconFolder({ className = "h-5 w-5" }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 12.75V6A2.25 2.25 0 014.5 3.75h4.086a2.25 2.25 0 011.59.659l1.122 1.122a2.25 2.25 0 001.59.659H19.5A2.25 2.25 0 0121.75 9v9.75A2.25 2.25 0 0119.5 21H4.5A2.25 2.25 0 012.25 18.75v-6z" />
    </svg>
  );
}
